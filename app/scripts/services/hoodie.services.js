...
const isProd = process.env.TRAVIS_BRANCH === 'master' || process.env.TRAVIS_BRANCH === 'release';

const BACK_URL = isProd ? 'https://prototypo.appback.com' : 'https://prototypo-dev.appback.com';
